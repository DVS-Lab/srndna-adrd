...
#outcome phase
        ...
        while timer.getTime() < outcome_dur:
            ...
            if trial['Feedback'] == '3' and resp_val == 8:
                ...
                outcome_color='lime'
                trials.addData('outcome_val', int(outcome_txt))
            elif trial['Feedback'] == '2' and resp_val == 8:
                outcome_txt = int(5)
                outcome_moneyTxt= 'n'
                outcome_color='white'
                trials.addData('outcome_val', int(outcome_txt))
                ...
                outcome_color='white'
                trials.addData('outcome_val', int(outcome_txt))
            elif trial['Feedback'] == '1' and resp_val == 8:
                outcome_txt = int(random.randint(6,9))
                outcome_moneyTxt= 'i'
